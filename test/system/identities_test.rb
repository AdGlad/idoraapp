...
class IdentitiesTest < ApplicationSystemTestCase
  ...
  test "creating a Identity" do
    ...
    fill_in "Desc", with: @identity.desc
    fill_in "Dob", with: @identity.dob
    fill_in "Name", with: @identity.name
    fill_in "Picture", with: @identity.picture
    fill_in "Team", with: @identity.team
    fill_in "User", with: @identity.user_id
