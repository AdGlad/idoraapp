...
#      post identities_url, params: { identity: { desc: @identity.desc, dob: @identity.dob, name: @identity.name, picture: @identity.picture, team: @identity.team, user_id: @identity.user_id } }
#    end
#
...
#    patch identity_url(@identity), params: { identity: { desc: @identity.desc, dob: @identity.dob, name: @identity.name, picture: @identity.picture, team: @identity.team, user_id: @identity.user_id } }
